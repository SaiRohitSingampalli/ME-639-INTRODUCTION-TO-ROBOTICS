...
cas = input('Enter the 1 for executing Question 4a and 2 for Question 4b');
i1 = 1/12*(m1*l1*l1);
i2 = 1/12*(m2*l2*l2);
g = 9.8;
%equations of motion
...
%ode
if cas==1
   [t,q] = ode45('torquenew',0:0.02:10,[0 0 0 0]);
else
    [t,q] = ode45('torquenew2',0:0.02:10,[0 0 0 0]);
end
za = 500;
%animation
for i = 1 : 1 : 500
...
%calculating values of joint variables and also energy terms
for i = 1:1:za+1
...
%Plotting the energy terms and joint variables
figure(2);
plot(t,K,'b');
hold on 
plot(t,V,'r');
