...
k11 = 10;  k12 = 10;  k01 = 25;  k02 = 25;
[t, q] = ode45('controltorqueterms', [0 2], [0;0;0;0]);
[ddd,eee]=size(q);
...
figure(8);
plot(t,QQ1-PQ1)
title('Difference in desired and simulated output in q1')
xlabel('time(s)')
ylabel('radian')
figure(9)
plot(t,QQ2-PQ3)
title('Difference in desired and simulated output in q2')
xlabel('time(s)')
ylabel('radian')